...
def run_model(DATADIR, run_name, modelType, embedding_dimension, vocab_size, training_epochs, padding_cutoff):
    ...
    dataset = process_data_set(DATADIR)
...
def collect_input_from_user():
    ...
    parser.add_argument("-dd", "--data_dir",
                        help="Path to the Amazon Review dataset", default="./amazon_reviews.csv")
    parser.add_argument("-vs", "--vocab_size", type=int,
                        help="Vocab size to be used in the model", default=400000)
    parser.add_argument("-ed", "--embedding_dimension", type=int,
                        help="Number of dimensions used in the vector space to represent words. Must be 50, 100, 200, 300 while using glove", default=200)
